...
const ChatMessageSchema = CollectionSchema(
  ...
  properties: {
    r'isPaginationLoading': PropertySchema(
      id: 0,
      name: r'isPaginationLoading',
      type: IsarType.bool,
    ),
...
void _chatMessageSerialize(
  ...
  writer.writeBool(offsets[0], object.isPaginationLoading);
...
ChatMessage _chatMessageDeserialize(
  ...
  final object = ChatMessage(
    isPaginationLoading: reader.readBoolOrNull(offsets[0]) ?? false,
    text: reader.readString(offsets[1]),
    timestamp: reader.readDateTime(offsets[2]),
    type: _ChatMessagetypeValueEnumMap[reader.readByteOrNull(offsets[3])] ??
        MessageType.sent,
  );
  object.id = id;
  return object;
...
extension ChatMessageQueryFilter
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterFilterCondition>
      isPaginationLoadingEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isPaginationLoading',
        value: value,
      ));
    });
  }
...
extension ChatMessageQuerySortBy
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy>
      sortByIsPaginationLoading() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isPaginationLoading', Sort.asc);
    });
  }

  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy>
      sortByIsPaginationLoadingDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isPaginationLoading', Sort.desc);
    });
  }
...
extension ChatMessageQueryWhereDistinct
  ...
  QueryBuilder<ChatMessage, ChatMessage, QDistinct>
      distinctByIsPaginationLoading() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'isPaginationLoading');
    });
  }
...
extension ChatMessageQueryProperty
  ...
  QueryBuilder<ChatMessage, bool, QQueryOperations>
      isPaginationLoadingProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isPaginationLoading');
    });
  }
